...
<body class="d-flex flex-column min-vh-100">
  ...
  <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    <div class="container">
      <a class="navbar-brand d-flex align-items-center gap-2 fw-bold text-success" href="{{ route('penerima.index') }}">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarTop">
        <ul class="navbar-nav mb-2 mb-lg-0 text-center">
          <li class="nav-item my-auto">
            <a class="nav-link text-secondary @yield('active-menu-home')" href="{{ route('penerima.index') }}">Beranda</a>
          </li>
          <li class="nav-item my-auto">
            <a class="nav-link text-secondary @yield('active-menu-proposal')" href="{{ route('penerima.proposal') }}">Proposal</a>
          </li>
          <li class="nav-item my-auto">
            @auth
              <a class="nav-link text-secondary @yield('active-menu-profile')" href="{{ route('penerima.profile') }}">
      ...
      <div class="row">
        ...
        <div class="col-md-3 mb-3">
          ...
          <ul class="list-unstyled small">
            <li><a href="{{ route('penerima.index') }}" class="text-muted text-decoration-none">Beranda</a></li>
            <li><a href="{{ route('penerima.proposal') }}" class="text-muted text-decoration-none">Proposal</a></li>
            <li><a href="{{ route('penerima.profile') }}" class="text-muted text-decoration-none">Profil</a></li>
          </ul>
        </div>
        <div class="col-md-3 mb-3">
