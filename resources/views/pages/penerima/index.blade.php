...
@section('custom_css')
  ...
  h1 {
    font-size: 2.5rem; /* fix untuk warning deprecation font-size */
  }
@endsection
  ...
  <div class="container">
    ...
    <div class="row align-items-center mb-5 mx-3">
      ...
      <div class="col-md-6" data-aos="fade-left">
        <h1 class="display-5 fw-bold mb-3">
          Galang Donasi Jadi Lebih Mudah di <span class="text-success">BarangKita</span>
        </h1>
        <p class="text-muted mb-4">
          BarangKita membantu anda menggalang barang untuk mereka yang membutuhkan. 
          Mulai dari panti asuhan, sekolah hingga korban bencana.
        </p>
        <a href="{{ route('penerima.tambahProposal') }}" class="btn btn-success btn-lg px-4" aria-label="Galang Sekarang">
          Galang Sekarang
        </a>
      </div>
    </div>
    ...
    <div class="text-center my-5 py-5 bg-success bg-opacity-10 px-5">
      ...
      <div class="row g-4 mt-4">
        ...
        <div class="col-md-4">
          <div class="bg-white border-0 rounded-4 shadow-sm h-100 p-4 text-center" data-aos="fade-up"
               data-aos-delay="{{ $loop->index * 150 }}">
            <i class="bi bi-{{ $feature['icon'] }} text-success fs-1 mb-3" style="width: 48px; height: 48px;" aria-hidden="true"></i>
            <h3 class="fw-semibold mb-2 h5">{{ $feature['title'] }}</h3>
    ...
    <section class="py-5 position-relative">
      <div class="container mb-5">
        ...
        <p class="text-center text-muted mb-5">
          Hanya dengan 3 langkah mudah, Anda sudah bisa memulai kebaikan.
        </p>
        @php
          $steps = [
        ...
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 border-0 rounded-4 text-center p-4 bg-white hover-shadow" data-aos="fade-up">
              ...
              <h3 class="fw-bold mb-2 h6">{{ $step['title'] }}</h3>
    ...
    <div class="text-center mt-5 py-5 bg-success bg-opacity-10" data-aos="fade-up">
      ...
      <p class="text-muted mb-4">
        Ayo mulai langkah kebaikanmu sekarang juga! Buat proposal penggalangan donasi dan bantu mereka yang membutuhkan di sekitarmu.
      </p>
      <a href="{{ route('penerima.tambahProposal') }}" class="btn btn-success px-4 py-2" aria-label="Galang Sekarang">
        Galang Sekarang
      </a>
    </div>
